...
import 'saved_track_trips_page_model.dart';
export 'saved_track_trips_page_model.dart';
import 'dart:ui' as ui;


class SavedTrackTripsPageWidget extends StatefulWidget {
  const SavedTrackTripsPageWidget({
    super.key,
  });


  @override
  State<SavedTrackTripsPageWidget> createState() => _SavedTrackTripsPageWidgetState();
}

class _SavedTrackTripsPageWidgetState extends State<SavedTrackTripsPageWidget> {
  late SavedTrackTripsPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SavedTrackTripsPageModel());
